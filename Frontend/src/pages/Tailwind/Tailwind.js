export const homeStyles = {
  ...
  heroBlurTop:
    'absolute top-20 right-0 w-96 h-96 bg-[#457b9d]/20 rounded-full blur-3xl -z-10',
  heroBlurBottom:
    'absolute bottom-0 left-0 w-72 h-72 bg-[#A8DADC]/40 rounded-full blur-3xl -z-10',
  heroGrid: 'grid md:grid-cols-2 gap-16 items-center',
  heroTextContent: 'space-y-8 animate-fadeIn',
  heroTitle:
    'text-6xl md:text-6xl font-black leading-tight tracking-tight text-[#1D3557]',
  heroTitleSpan: 'block md:text-5xl text-[#457b9d]',
  heroDescription:
    'text-slate-600 text-xl font-medium max-w-lg leading-relaxed',
  ...
  splitSection:
    'relative w-full h-[600px] md:h-[700px] flex flex-col md:flex-row bg-[#0f172a]',
  splitLeft:
  ...
  featuresSection:
    'py-10 border-y border-[#457b9d]/20 bg-white/50 backdrop-blur-sm',
  ...
  productBadge:
    'text-[#457b9d] font-bold tracking-widest uppercase text-sm mb-2',
  ...
  ctaDesc:
    'text-[#A8DADC] text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light',
  ctaBtn:
...
export const cartStyles = {
  container:
    'min-h-screen bg-[#F1FAEE] text-slate-800 px-6 pt-[100px] relative overflow-hidden',
  backgroundBlur:
    'absolute top-0 right-0 w-96 h-96 bg-[#457b9d]/10 rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/3',
  title:
    'text-3xl text-center md:text-5xl font-black mb-12 text-[#1D3557] tracking-tight',
...
export const forgetStyles = {
  ...
  blurBottom:
    'absolute bottom-[-10%] right-[-5%] w-80 h-80 bg-[#1D3557]/10 rounded-full blur-3xl',
  ...
  footerLink:
    'text-[#1D3557] font-bold hover:text-[#457b9d] hover:underline transition-all',
};
...
export const loginStyles = {
  container:
    'min-h-screen flex items-center justify-center bg-[#F1FAEE] px-4 relative overflow-hidden',
  blurTop:
    'absolute top-[-10%] left-[-5%] w-96 h-96 bg-[#457b9d]/10 rounded-full blur-3xl',
  blurBottom:
    'absolute bottom-[-10%] right-[-5%] w-80 h-80 bg-[#1D3557]/10 rounded-full blur-3xl',
  ...
  forgotLink:
    'text-slate-500 hover:text-[#457b9d] font-semibold transition-colors',
  ...
  registerLink:
    'text-[#1D3557] font-bold hover:text-[#457b9d] hover:underline transition-all ml-1',
};
...
export const orderStyles = {
  ...
  orderHeader:
    'flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b pb-4',
  ...
  emptyState:
    'flex flex-col items-center justify-center text-center min-h-[60vh] w-full',
  browseBtn:
    'mt-4 px-8 py-3 bg-[#1D3557] text-white rounded-full font-bold hover:bg-[#457b9d] transition',
};
...
export const notFoundStyles = {
  ...
  blurTop:
    'absolute top-20 left-20 w-72 h-72 bg-[#457b9d]/10 rounded-full blur-3xl',
  blurBottom:
    'absolute bottom-20 right-20 w-80 h-80 bg-[#1D3557]/10 rounded-full blur-3xl',
  ...
  errorCode:
    'text-[10rem] font-black text-[#1D3557]/5 leading-none select-none',
...
export const productStyles = {
  container:
    'min-h-screen bg-[#F1FAEE] text-slate-800 p-6 pt-24 relative overflow-x-hidden',
  blurEffect:
  ...
  navBtn:
    'text-[#457b9d] font-bold hover:text-[#1D3557] transition-colors flex items-center gap-2',

  // Main Layout
  mainGrid:
    'max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start',
  ...
  title:
    'text-4xl md:text-5xl font-black text-[#1D3557] tracking-tight leading-tight',
...
export const registerStyles = {
  container:
    'min-h-screen flex items-center justify-center bg-[#F1FAEE] px-4 relative overflow-hidden',
  blurRight:
    'absolute top-[-10%] right-[-5%] w-96 h-96 bg-[#457b9d]/10 rounded-full blur-3xl',
  blurLeft:
    'absolute bottom-[-10%] left-[-5%] w-80 h-80 bg-[#1D3557]/10 rounded-full blur-3xl',
...
export const shopStyles = {
  ...
  headerWrapper: 'text-center mb-12',
  topBadge:
    'text-[#457b9d] font-bold tracking-widest uppercase text-xs mb-3 block',
  ...
  controlsWrapper:
    'max-w-7xl mx-auto flex items-center justify-between my-6 gap-6',
  searchInput:
...
export const wishlistStyles = {
  ...
  topBadge:
    'text-[#457b9d] font-bold tracking-widest uppercase text-xs mb-1 block',
  title: 'text-4xl md:text-5xl font-black text-[#1D3557] tracking-tight',
  accentText: 'text-[#457b9d]',
